...
extern void dwt_delay_us(uint32);
UART_MemMapPtr UARTN[UART_MAX] = {UART0_BASE_PTR, UART1_BASE_PTR, UART2_BASE_PTR, UART3_BASE_PTR, UART4_BASE_PTR, UART5_BASE_PTR}; //定义6个指针数组保存 UARTN 的地址
...
//          if(0xff!=*buff){
 ...
 //         }
 //         else{
 //           uart_putchar(uratn,0xfe);
 //         }
		buff++;
                
                dwt_delay_us(86);
	}
//        uart_putchar(uratn,0xff);
}
